  ...
  return (
    <Form className='p-4 border rounded m-3'>
        ...
        <Form.Group controlId='formNombre'>
            ...
            <Form.Control type='text' name="imagen" placeholder="Ingrese nombre producto" value={values.imagen} onChange={handleChange} />
        ...
        <Form.Group controlId='formNombre'>
            ...
            <Form.Control type='number' name="precio" placeholder="Ingrese nombre producto" value={values.precio} onChange={handleChange}/>
